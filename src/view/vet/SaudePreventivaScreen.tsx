...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#9C27B0', padding: 20, paddingTop: 20, paddingBottom: 20 },
  ...
  filterButtonActive: { backgroundColor: '#9C27B0' },
  ...
  dataAtrasada: { color: '#f44336', fontWeight: 'bold' },
